...
const AboutUs = () => {
    ...
    return (
        <motion.div
            className="flex flex-col md:flex-row justify-between items-center  p-8 rounded-lg shadow-lg max-w-8xl mx-auto  bg-white dark:bg-gray-900 text-black dark:text-white my-10"
