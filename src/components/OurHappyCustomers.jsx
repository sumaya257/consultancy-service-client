      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={index}
              className=" p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300  dark:bg-gray-100  dark:text-black"
            ...
            >
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h3 className="font-semibold text-lg text-gray-800 dark:text-black">{testimonial.name}</h3>
                </div>
              </div>
              <p className="text-gray-600 dark:text-black">{testimonial.feedback}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
