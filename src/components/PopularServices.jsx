    ...
    return (
        <div className="max-w-8xl mx-auto p-4">
            <h2 className="text-3xl font-semibold text-center
             mb-6">Popular Services</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {popularServices.map((service) => (
                    <div key={service._id} className="service-card border p-3 rounded-lg shadow-lg  dark:bg-gray-100">
                        <img
                        ...
                        <div className="service-info p-4">
                            <h3 className="text-xl font-semibold dark:text-black">{service.serviceName}</h3>
                            ...
                            <div className="flex items-center justify-between mt-2">
                                ...
                                <span className="text-lg font-semibold dark:text-black">{`$${service.price}`}</span>
                            </div>
                        ...
                        <div className="provider-info flex items-center mt-4 dark:text-black">
                            <img
